...
@NgModule({
  ...
  providers: [ AuthGuard, AlertService, LoadingService, AuthService, SectionService, StandardService, 
    StudentService, TeacherService, TransportManagerService, FinanceManagerService, PrincipalService, CounsellorService, AttendanceService, StationeryService],
