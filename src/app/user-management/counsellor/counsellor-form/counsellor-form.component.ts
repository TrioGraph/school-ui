...
export class CounsellorFormComponent extends TabManager implements OnInit {
  ...
  this.form = this.fb.group({
    ...
    this.route.paramMap
    .subscribe((params: any) => { params.get('id') !== undefined && params.get('id') !== null
     this.counsellorService.getById(params.get('id'))
    .subscribe((res: any)=> {
...
onSubmit() {
    ...
    if (this.form.valid) {
      ...
      this.counsellorService.add(this.form.value).subscribe((res: any)=> {
        this.loadingService.display(false);
