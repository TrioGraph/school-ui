              ...
              <tbody>
                <tr class="{{trClass}}" *ngFor="let row of service.tableRowsObjects">
                  <td class="{{tdClass}}" *ngFor="let cell of row.cells">
                    ...
                    <!-- && cell.touched -->
                        <div class="ui input requiredInput" [ngClass]="{errorClass: !cell.content}" 
...
export class EditableTableComponent implements OnInit {
  ...
  @Input('add-button-label')
  addButtonLabel!: string;
  @Input('edit-button-label')
  editButtonLabel!: string;
  @Input('save-button-label')
  saveButtonLabel!: string;
  @Input('cancel-button-label')
  cancelButtonLabel!: string;
  @Input('delete-button-label')
  ...
  @Input('add-button-class')
  addButtonClass!: string;
  @Input('edit-button-class')
  editButtonClass!: string;
  @Input('delete-button-class')
